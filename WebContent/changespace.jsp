		...
		<form action="#">
			<div id="page-wrapper">
				...
				<div class="form-group">
					<label for="birth-city">Select Space:</label><br> <input
						type="text" name="birth-city" class="birth-city form-control"
						id="birth-city" required="required">
				</div>
				<div class="form-group">
					<label for="birth-city">Password:</label><br> <input
						type="password" name="birth-city" class="birth-city form-control"
						id="birth-city" required="required">
				</div>
				<div class="form-group">
					<label for="birth-city">Why do u need change:</label><br> <input
						type="text" name="birth-city" class="birth-city form-control"
						id="birth-city" required="required">
				</div>
